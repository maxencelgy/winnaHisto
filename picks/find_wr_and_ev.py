#!/usr/bin/env python3
"""WR AND EV filters combinés simultanément — jamais testé."""
import sys, os, json
...
for i, s in enumerate(CANDS):
    ...
    try:
        ...
        if r["n_cycles_total"] >= 25 and r["final_pnl"] > 3000:
            results.append({
                "id": s["id"],
...
with open("/tmp/find_wr_and_ev.json","w") as f: json.dump(results,f,indent=2)
print("\nSaved")
